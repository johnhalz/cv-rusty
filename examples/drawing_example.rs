...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    draw_rectangle(
        ...
        Some(Stroke::new(3, Color::rgb(0, 0, 0))), // stroke (3px black)
    ...
    draw_rectangle(
        ...
        Some(Stroke::new(2, Color::rgb(0, 0, 255))), // stroke (2px blue)
    ...
    draw_circle(
        ...
        380.0,                                           // position (x, y)
        60.0,                                            // radius
        Some(Stroke::new(4, Color::rgb(255, 255, 255))), // stroke (4px white)
    ...
    draw_circle(
        ...
        380.0,                                         // position (x, y)
        55.0,                                          // radius
        Some(Stroke::new(5, Color::rgb(255, 0, 255))), // stroke (5px magenta)
        None,                                          // no fill
    );
    ...
    draw_rectangle(
        ...
        Some(Stroke::new(4, Color::rgb(128, 0, 128))), // stroke (4px purple)
        None,                                          // no fill
    );
